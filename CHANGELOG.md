...
(SKIP this--use "2010-10-27 redacted" instead)
### Changed
...
(identical to 2014-04-15 version except the following)
...
## 2017-12-02 (last non-git copy):
(SKIP: commit "2017-12-02 redacted" instead; seems to be based on "2014-04-15"--mostly identical except some changes and additions)
...
(2018-12-11 version) same as 2017-12-02 except:
### Changed
